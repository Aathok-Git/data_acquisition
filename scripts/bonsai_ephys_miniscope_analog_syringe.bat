@echo off
REM Bonsai launcher for Ephys + Miniscope + Analog Inputs + Syringe
...
set "SCRIPT=%~dp0..\bonsai\bonsai_ephys_miniscope_analog_syringe.bonsai"
set "LAYOUT=%~dp0..\bonsai\bonsai_ephys_miniscope_analog_syringe.layout"
