@echo off
REM Bonsai launcher for Miniscope + Analog Inputs
...
set "SCRIPT=%~dp0..\bonsai\bonsai_miniscope_analog.bonsai"
set "LAYOUT=%~dp0..\bonsai\bonsai_miniscope_analog.layout"
...
REM This workflow file should be configured for both miniscope and analog input data acquisition.

set "BONSAI_EXE=C:\Program Files\Bonsai\Bonsai.exe"
set "SCRIPT=%~dp0workflow_miniscope_analog.bonsai"

REM Run Bonsai with miniscope + analog configuration
"%BONSAI_EXE%" "%SCRIPT%"
